...
async function sendLearnMessage(text) {
  ...
  try {
    ...
    appendLearnMessage(reply, 'bot', {
      ...
      userMessage: text,
      response: reply,
      lesson: 'This entire reply was generated by a different system prompt than the volunteer helper chat. Same model, different "personality" — that\'s the power of prompts.'
    });
  } catch (err) {
    hideLearnTyping();
    appendLearnMessage(
